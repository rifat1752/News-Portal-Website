      ...
      <form onSubmit={handleRegister} className="card-body w-96">
        <div className="form-control">
          <label className="label">
            <span className="label-text text-base  font-semibold">Your Name</span>
          </label>
        ...
        <div className="form-control mt-6">
          <button className="btn bg-slate-900 text-slate-100 text-2xl">Register</button>
        </div>
        <div className="text-center text-sm"> 
            <p className="ml-5"> Have an Account? <Link to='/login' className="hover:underline text-green-600 hover:text-green-600 font-semibold ml-2"> Log In</Link></p>
            </div>
      </form>
    </div>
  </div>
