  ...
  return (
    <div className="">
      <div className="py-5 h-96 flex flex-col justify-center items-center ">
        ...
        <h1 className="text-5xl text-[#005A7F] font-bold text-poppins"> Libertatio</h1>
      ...
      <div className="  ">
          <p className="py-10 px-5 md:px-10 text-center text-xl text-slate-500 font-semibold ">
            <i>
      ...
      <div>
        ...
        <div className="flex flex-col justify-center items-center ">
          <img className="w-20 h-20 " src="https://i.ibb.co.com/xX8nfFf/logo.png" alt="" />
        <h1 className="text-5xl text-poppins py-5  text-center font-bold text-[#005A7F] ">Our Team</h1>
          <p className="  px-5 md:px-10 text-center text-xl text-] font-semibold ">
           <i>
  ...
  <div className="opacity-0 rounded group-hover:opacity-100 transition-opacity  duration-500  transform translate-y-full group-hover:translate-y-0 flex flex-col justify-center gap-5 group-hover:bg-[#005b7f88] backdrop-blur-sm w-80 h-96 absolute">
    ...
    <p className="text-2xl font-semibold text-poppins text-[#ff7d56]">{employee.position}</p>
      ...
      <div className="my-14 py-10  rounded-lg gap-5  flex flex-col ">
        <div className=" ">
          <h1 className="text-5xl text-[#005A7F] text-poppins text-center font-bold">
            Our Vision
          </h1>
        </div>
        <div className=" italic  px-5  py-5 flex  flex-row justify-around items-center gap-3 text-justify text-xl font-medium  text-slate-200 ">
        <img className="w-96 h-[400px]  rounded hover:rotate-1 transition-all duration-300 shadow-slate-400 " src="https://i.ibb.co.com/d2WcCtz/news-concept.webp" alt="news"/>
        <div className="w-5/12">
        <img className="w-20 h-20 mx-auto " src="https://i.ibb.co.com/xX8nfFf/logo.png" alt="" />
        <p className="  text-center text-xl font-medium text-slate-700 my-3">
      ...
      <div className="my-14 py-10  rounded-lg  flex flex-col gap-5 ">
        ...
        <div className=" px-5  py-5 flex  flex-row justify-around items-center gap-3 text-justify text-xl font-medium  text-slate-200 ">
        <img className="w-96 h-[400px]  rounded hover:rotate-1 transition-all duration-300  " src="https://i.ibb.co.com/9yprKJX/newssit.webp" alt="news"/>
        <div className="w-5/12">
        
        
          <ul className="flex flex-col gap-3  text-xl font-medium  text-slate-700 my-3">
              <li>
                <p className="text-2xl font-semibold text-poppins border-b-2  w-60 text-[#ff7d56] border-[#ff7d56]">Unbiased Reporting </p>
              ...
              <li>
                <p className="text-2xl font-semibold text-poppins border-b-2  w-60 text-[#ff7d56] border-[#ff7d56]">
                Timeliness
                </p>
                <p className="italic text-lg">
                We
